...
const dashboardItemsAdmin = [
  ...
  { iconPath: 'icons-tareas.png', altText: 'Notificaciones', buttonText: 'Notificaciones', path: '/trabajos', classIcon: 'fa fa-envelope', classTextos: 'enlaces' },
  ...
  { iconPath: 'icons-inventario.png', altText: 'Vehiculos', buttonText: 'Vehiculos', path: '/inventario', classIcon: 'fa fa-car', classTextos: 'enlaces' },
