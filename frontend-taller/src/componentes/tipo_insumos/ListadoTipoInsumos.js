...
function ListadoTipoInsumos(){
    ...
    const listarTipoInsumos = async() =>{
        await Axios.get("http://localhost:8010/api/tipoInsumos/general/",{headers: {'Authorization': token,},})
    ...
    const tabla = useReactTable(
        {
            data: tipoInsumosList,columns: columnas, getCoreRowModel: getCoreRowModel(), 
...
export default ListadoTipoInsumos